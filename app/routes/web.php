...
Route::prefix('admin-africa')->name('panel.')->group(function () {
...
//    echo sprintf('locale: %s, route: %s', $locale, 'main');
//    die();
//});

//Route::get('/{locale?}/news', function ($locale = null) {
//    echo sprintf('locale: %s, route: %s', $locale, 'news');
//    die();
//});
