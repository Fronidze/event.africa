    ...
    <div class="program_festival__description">
        ...
        <div id="music" class="program_festival__element">
            <div class="container element">
                ...
                <p class="element__description no_margin__top">Салиф Кейта - всемирно известный автор и исполнитель направления афро-поп из Мали. Салиф известен тем, что его считают золотым голосом Африки, а также тем, что он является прямым потомком основателя империи Мали, Сундьяты Кейта.</p>

                <p class="element__list__title text-orange no_margin__bottom">Ismael LO (Senegal)</p>
                <p class="element__description no_margin__top">Исмаэль Ло — автор неофициального гимна Африканского союза «Джамму Африка / Мир Африке». Исмаэль Ло играл в составе группы Super Diamond. В начале 80-х он начал сольную карьеру, а в 1981 г. записал дебютный альбом "Gor Sayina". В Африке Исмаэля Ло называют сенегальским Бобом Диланом, за его манеру игры на гитаре и губной гармошке, а также за глубокомысленную лирику.</p>

                <p class="element__list__title text-orange no_margin__bottom">Didier Awadi (Senegal)</p>
                <p class="element__description no_margin__top">Музыкант и продюсер, Дидье Авади является одним из главных звезд сенегальского и западноафриканского хип-хоп движения.</p>

                <p class="element__list__title text-orange no_margin__bottom">Iemi Alade (Nigeria)</p>
                <p class="element__description no_margin__top">Певица, композитор, актриса и активистка. Йеми считается одним из величайших артистов Африки. Она выделяется своими творческими выступлениями на сцене, своими модными и музыкальными клипами. Аладе является второй нигерийской и афробитской артисткой и первой женщиной, которая набрала 100 миллионов просмотров за одно видео на YouTube.</p>
        ...
        <div id="photo" class="program_festival__element">
            <div class="container element">
                ...
                <div class="element_subsection">
                    <p class="element__title__sub text-orange">“История Африканского фотоархива” <span class="no_bold">от галереи Люмьер</span></p>
